...
| Shortcut | 说明 |
|----------|------|
| [`+search`](references/lark-doc-search.md) | ⚠️ **已弃用 — 请使用 [`drive +search`](../lark-drive/references/lark-drive-search.md)**。搜索飞书文档、Wiki 和电子表格文件（Search v2: doc_wiki/search）。保留是为了向后兼容；新流程应使用 drive 域命令配合扁平 flag。 |
| [`+create`](references/lark-doc-create.md) | 创建飞书文档（XML / Markdown） |
| [`+fetch`](references/lark-doc-fetch.md) | 获取飞书文档内容（XML / Markdown） |
| [`+update`](references/lark-doc-update.md) | 更新飞书文档（str_replace / block_insert_after / block_replace / ...） |
| [`+media-insert`](references/lark-doc-media-insert.md) | 在飞书文档末尾插入本地图片或文件（4 步编排 + 自动回滚）。当图片已在系统剪贴板上（截图、从飞书/浏览器复制）时优先使用 `--from-clipboard`；仅对磁盘上的源文件使用 `--file`。 |
| [`+media-download`](references/lark-doc-media-download.md) | 下载文档媒体或画板缩略图（自动检测扩展名） |
| [`+whiteboard-update`](../lark-whiteboard/references/lark-whiteboard-update.md) | `whiteboard +update` 的别名。使用 DSL、Mermaid 或 PlantUML 更新现有画板。优先使用 `whiteboard +update`；详情参见 lark-whiteboard 技能。 |
